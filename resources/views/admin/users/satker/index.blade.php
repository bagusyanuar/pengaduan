    ...
    <div class="container-fluid">
        <div class="d-flex align-items-center justify-content-between mb-3">
            <ol class="breadcrumb breadcrumb-transparent mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">User Satuan Kerja
                </li>
            </ol>
        </div>
    </div>
        ...
        <div class="card card-outline card-warning">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <p class="mb-0">Data User Satuan Kerja</p>
                    <a href="{{ route('users.satker.add') }}" class="main-button f14">
                ...
                <table id="table-data" class="display w-100 table table-bordered">
                    ...
                    @foreach($data as $v)
                        <tr>
                            ...
                            <td class="f14">{{ $v->satker->unit->name }}</td>
                            <td class="f14">{{ $v->satker->name }}</td>
                            <td class="f14">{{ $v->satker->phone }}</td>
                            <td width="10%" class="text-center">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu dropdown-menu-right">
                                        <a href="{{ route('users.satker.patch', ['id' => $v->id])  }}"
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function destroy(id) {
            AjaxPost(prefix_url + '/admin/users/satuan-kerja/' + id + '/delete', function () {
