    ...
    <div class="container-fluid">
        <div class="d-flex align-items-center justify-content-between mb-3">
            <ol class="breadcrumb breadcrumb-transparent mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">User UKI
                </li>
            </ol>
        </div>
    </div>
        ...
        <div class="card card-outline card-warning">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <p class="mb-0">Data User UKI</p>
                    <a href="{{ route('users.uki.add') }}" class="main-button f14">
            ...
            <div class="card-body">
                <table id="table-data" class="display w-100 table table-bordered">
                    ...
                    <tr>
                        ...
                        <th class="f14" width="20%">Email</th>
                    ...
                    @foreach($data as $v)
                        <tr>
                            ...
                            <td class="f14">{{ $v->uki->name }}</td>
                            <td class="f14">{{ $v->uki->phone }}</td>
                            <td width="10%" class="text-center">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu dropdown-menu-right">
                                        <a href="{{ route('users.uki.patch', ['id' => $v->id])  }}"
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function destroy(id) {
            AjaxPost(prefix_url + '/admin/users/uki/' + id + '/delete', function () {
