            ...
            <ul class="nav nav-sidebar nav-pills flex-column">
                <nav class="mt-2 nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    @if(auth()->user()->role == 'uki')
                        ...
                        <li class="nav-item has-treeview {{ request()->is('admin-uki/pengaduan*') ? 'menu-open' : ''}}">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('complain.answered.uki') }}"
                                       class="nav-link {{ request()->is('admin-uki/pengaduan/jawab*') ? 'active' : ''}}">
                                        <i class="fa fa-circle-o nav-icon" aria-hidden="true"></i>
                                        <p>Terjawab</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('complain.finished.uki') }}"
                                       class="nav-link {{ request()->is('admin-uki/pengaduan/selesai*') ? 'active' : ''}}">
                                        <i class="fa fa-circle-o nav-icon" aria-hidden="true"></i>
                                        <p>Selesai</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item has-treeview {{ request()->is('admin-uki/informasi*') ? 'menu-open' : ''}}">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('information.answered.uki') }}"
                                       class="nav-link {{ request()->is('admin-uki/informasi/jawab*') ? 'active' : ''}}">
                                        <i class="fa fa-circle-o nav-icon" aria-hidden="true"></i>
                                        <p>Terjawab</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('information.finished.uki') }}"
                                       class="nav-link {{ request()->is('admin-uki/informasi/selesai*') ? 'active' : ''}}">
                                        <i class="fa fa-circle-o nav-icon" aria-hidden="true"></i>
                                        <p>Selesai</p>
                                    </a>
                                </li>
                    ...
                    @if(auth()->user()->role == 'ppk')
                        ...
                        <li class="nav-item has-treeview {{ request()->is('admin-ppk/informasi*') ? 'menu-open' : ''}}">
                            <a href="#" class="nav-link {{ request()->is('admin-ppk/informasi*') ? 'active' : ''}}">
                                <i class="nav-icon fa fa-info"></i>
                                <p>
                                    Informasi
                                    <i class="right fa fa-angle-down"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('information.index.ppk') }}"
                                       class="nav-link {{ request()->is('admin-ppk/informasi') ? 'active' : ''}}">
                                        <i class="fa fa-circle-o nav-icon" aria-hidden="true"></i>
                                        <p>Data</p>
                                    </a>
                                </li>
