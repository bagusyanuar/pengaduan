...
<body>
<img src="{{ public_path('assets/icons/kop.jpeg') }}" alt="kop" height="60" style="width: 100%">
<hr>
...
<br>
<div style="text-align:  justify; font-size: 12px; text-indent: 50px;">Menindaklanjuti Nota Dinas dari {{ $data->name }} nomor {{ $data->ticket_id }}
