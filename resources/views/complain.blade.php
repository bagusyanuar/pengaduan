                                ...
                                <div class="card-body">
                                    <form>
                                        ...
                                        <div class="form-group mb-1">
                                            ...
                                            <input type="email" class="form-control" id="job" aria-describedby="emailHelp"
                                                   placeholder="Email">
                                            <small id="emailHelp" class="form-text text-muted">Contoh : pelapor@gmail.com</small>
                                        </div>
                                        <div class="form-group mb-1">
                                            <label for="complain">Saran / Pengaduan</label>
                                            <textarea rows="3" class="form-control" id="complain"
                                                      aria-describedby="complainHelp" placeholder="Saran / Pengaduan"></textarea>
                                            <small id="complainHelp" class="form-text text-muted">Contoh : Jl. Arjuna no.
                                                16, Kec. Serengan, Surakarta</small>
                                        </div>
                                    </form>
                                </div>
