    ...
    <div class="row">
        <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="small-box bg-danger">
                ...
                <a href="{{ route('complain.index.satker') }}" class="small-box-footer">Lihat lebih <i
        ...
        <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="small-box bg-info">
                ...
                <a href="{{ route('information.index.satker') }}" class="small-box-footer">Lihat lebih <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="card card-outline card-warning mt-3">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <p class="mb-0 f14 font-weight-bold">Data Pengaduan Baru</p>
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
            <div class="card card-outline card-success mt-3">
                ...
                <div class="card-body">
                    <table class="display w-100 table table-bordered nowarp" id="table-data-information">
                        <thead>
                        <tr>
                            <th width="5%" class="text-center f12 no-sort"></th>
                            <th width="5%" class="text-center f12">#</th>
...
@section('js')
    ...
    <script>
        ...
        function generateTableComplain() {
            tableComplain = DataTableGenerator('#table-data-complain', prefix_url + '/admin-satker/pengaduan/data', [
                {
        ...
        function generateTableInformation() {
            tableInformation = DataTableGenerator('#table-data-information', prefix_url + '/admin-satker/informasi/data', [
                {
                    className: 'dt-control',
                    orderable: false,
                    data: null, render: function () {
