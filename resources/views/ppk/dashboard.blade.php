    ...
    <div class="row">
        <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="small-box bg-danger">
                ...
                <a href="{{ route('complain.index.ppk') }}" class="small-box-footer">Lihat lebih <i
        ...
        <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="small-box bg-info">
                ...
                <a href="{{ route('information.index.ppk') }}" class="small-box-footer">Lihat lebih <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
    </div>
    <div class="row">
...
@section('js')
    ...
    <script>
        ...
        function generateTableComplain() {
            tableComplain = DataTableGenerator('#table-data-complain', prefix_url + '/admin-ppk/pengaduan/data', [
                {
        ...
        function generateTableInformation() {
            tableInformation = DataTableGenerator('#table-data-information', prefix_url + '/admin-ppk/informasi/data', [
                {
                    className: 'dt-control',
                    orderable: false,
                    data: null, render: function () {
